...
function App() {
  ...
  const projects = [
    {
      ...
      description: "A comprehensive web-based Employee Management System built with Java technologies, featuring complete CRUD operations, employee data management, and a user-friendly interface for HR operations.",
      features: [
        "Developed a full-stack Employee Management System using Java, Servlets, and Hibernate for backend operations",
        "Implemented comprehensive CRUD operations for employee data management with MySQL database integration",
        "Built responsive web interface using HTML, CSS, and JavaScript for seamless user experience",
        "Utilized Maven for project management and dependency handling with proper build lifecycle",
        "Applied MVC architecture pattern for clean separation of concerns and maintainable code structure",
        "Integrated JUnit testing framework for unit testing and code quality assurance"
      ],
      technologies: ["Java", "Servlets", "Hibernate", "MySQL", "HTML5", "CSS3", "JavaScript", "Maven", "JUnit"],
      githubUrl: "https://github.com/hemanth-devzone/EmployeeManagementSystem",
  ...
  const skillCategories = {
    ...
    backend: {
      ...
      skills: ["Spring Boot", "Hibernate", "Servlets", "JDBC", "REST APIs", "Node.js"],
      color: "bg-green-500"
    },
    frontend: {
      title: "Frontend Technologies", 
      skills: ["React", "Bootstrap", "Tailwind CSS", "Responsive Design"],
      color: "bg-purple-500"
    },
    database: {
      title: "Databases",
      skills: ["MySQL", "OracleDB", "NoSQL", "MongoDB"],
      color: "bg-orange-500"
    },
    tools: {
      title: "Tools & Platforms",
      skills: ["Git", "Maven", "JUnit", "Eclipse IDE", "VS Code", "ChatGPT", "AI Prompts"],
      color: "bg-indigo-500"
    },
    security: {
